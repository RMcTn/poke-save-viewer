class Gen2EntriesController < ApplicationController
  ...
  def get_pokemon_from_save(save_file, pokemon_offset, nickname_offset)
    ...
    pokemon = Gen2PokemonStruct.new(pokemon_id: pokemon_id, current_hp: current_hp, status_condition: status_condition, type1_id: type1_id, type2_id: type2_id, move1_id: move1_id, move2_id: move2_id, move3_id: move3_id, move4_id: move4_id, max_hp: max_hp, level: level, nickname: nickname)
